 ...
 * model_pendulum.c's mat_type convention): none of the above should depend on
 * which interpolation scheme or Jacobian callback is used, so all
 * combinations must agree BIT FOR BIT.
 * ---------------------------------------------------------------------------*/
